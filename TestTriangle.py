...
class TestTriangles(unittest.TestCase):
    ...
    def testScaleneTriangleA(self): 
        self.assertEqual(classifyTriangle(6,7,5),'Scalene','6,7,5 is a Scalene triangle')
    ...
    def testInputDatatypeTriangleA(self): 
        self.assertEqual(classifyTriangle(4,1.5,2),'InvalidInputThree','4,1.5,2 is a InvalidInput')

    def testFormationTriangleA(self): 
        self.assertEqual(classifyTriangle(6,3,2),'NotATriangle','6,3,2 is a NotATriangle')
